...
class LastStatementsForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.add_input(
            Submit('view_last_statements', 'View last statements'))
...
class TopQueriesForm(forms.Form):
    ...
    column = forms.ChoiceField(
        help_text='Column to initially sort by.')
    hostname = forms.ChoiceField(
        required=False,
        help_text='Select hostname to include in the result.')
    schema = forms.ChoiceField(
        required=False,
        help_text='Select schema to include in the result.')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.add_input(
            Submit('view_top_queries', 'View top queries'))
