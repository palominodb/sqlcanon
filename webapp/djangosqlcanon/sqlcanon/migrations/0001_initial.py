...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'statements', (
            ...
            ('schema', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal(u'sqlcanon', ['StatementData'])
        ...
        db.send_create_signal(u'sqlcanon', ['ExplainedStatement'])

        # Adding model 'ExplainResult'
        db.create_table(u'explain_results', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('explained_statement', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'explain_results', null=True, db_column=u'explained_statement_id', to=orm['sqlcanon.ExplainedStatement'])),
        ...
        db.send_create_signal(u'sqlcanon', ['ExplainResult'])
    ...
    models = {
        ...
        u'sqlcanon.explainresult': {
            'Meta': {'object_name': 'ExplainResult', 'db_table': "u'explain_results'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'explained_statement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'explain_results'", 'null': 'True', 'db_column': "u'explained_statement_id'", 'to': u"orm['sqlcanon.ExplainedStatement']"}),
