# Django settings for djangosqlcanon project.
...
SECRET_KEY = 'qtgm#%8di!*hi4$wh6bt1-p3=%g99*-%b_4&amp;8@bwij$ir6nwe#'
...
ROOT_URLCONF = 'djangosqlcanon.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'djangosqlcanon.wsgi.application'
